...
function searchCollection() {
	var cate_name = $('.list_search .search_item.active').attr('cate-name');
	var cate_id = $('.list_search .search_item.active').attr('cate-id');
	var system_id = $('.list_search .search_item.active').attr('system-id');
