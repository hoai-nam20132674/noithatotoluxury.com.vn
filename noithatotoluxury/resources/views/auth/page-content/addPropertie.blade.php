	...
	<div class="content-area py-1">
		<div class="container-fluid">
			...
			<div class="box box-block bg-white">
                ...
                @endif
				<form action="{{URL::route('postAddPropertie')}}" method="POST" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="col-md-8">
									...
									<div class="form-group">
										<label for="exampleInputEmail1">Tên loại thuộc tính</label>
										<input type="text" class="form-control" name="name" placeholder="tên loại thuộc tính" value="{{old('propertie_type')}}" required>
									</div>
									<div class="form-group pr">
										<label for="exampleInputEmail1">giá trị 1</label>
										<input type="text" class="form-control" name="propertie[]" placeholder="giá trị thuộc tính" value="" >
									</div>
									<div id="pr-plus"></div>
