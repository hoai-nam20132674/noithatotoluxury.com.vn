...
@section('content')
	<div class="content-area py-1">
		<div class="container-fluid">
			<h4>Dịch vụ sửa chữa nokia 8800</h4>
					...
					<thead>
						<tr>
							...
							<th class="text-center" style="padding: 0px; background: green;">
								<a href="{{URL::route('addNokiaError')}}" title="Thêm dịch vụ sửa chữa nokia 8800" style="color: green;"><i class="ion-android-add" style=" font-size:30px;color:#fff;"></i></a>
							</th>
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								<a onclick="return confirmDelete('Bạn có chắc muốn xóa dịch vụ này không')" href="{{ URL::route('deleteNokiaError',$error->id)}}" title="Xóa dịch vụ"><i class="ion-trash-a" style="width: 100%; font-size: 18px; color: red; margin-right: 5px;"></i></a>
								<a href="{{ URL::route('editNokiaError',$error->id)}}" title="Sửa dịch vụ"><i class="ion-compose" style="width: 100%; font-size: 18px;"></i></a>
							</td>
						</tr>
						@endforeach
					</tbody>
